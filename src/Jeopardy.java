...
public class Jeopardy implements ActionListener {
	...
	private void start() {
		...
		frame.setTitle("Dumpling");
		// 3. Create a JPanel variable to hold the header using the createHeader method
		JPanel header = createHeader("Yo mama");
	...
	public void actionPerformed(ActionEvent saltedcaramelbrownies) {
		// Remove this temporary message:
		JOptionPane.showMessageDialog(null,
				"pressed " + ((JButton) saltedcaramelbrownies.getSource()).getText() + " button");

		// Use the method that plays the jeopardy theme music.

		JButton buttonPressed = (JButton) saltedcaramelbrownies.getSource();
		// If the buttonPressed was the firstButton
		if (buttonPressed == firstButton) {
			askQuestion("What is life?", " Life ", 200);
		}
